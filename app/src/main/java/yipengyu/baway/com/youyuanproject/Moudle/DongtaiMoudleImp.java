...
public class DongtaiMoudleImp implements  IphotoMoudle{
    @Override
    public void getfile(File file, final PhotoListener photolister) {
        ...
        String picwidth = PreferencesUtils.getValueByKey(IApplication.getApplication(),"xwidth","100");
        String picheight = PreferencesUtils.getValueByKey(IApplication.getApplication(),"xheight","100");
