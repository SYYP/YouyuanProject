...
public class HorizontalselectedView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        selectedTextSize = tta.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewSelectedTextSize, 20);
        ...
        textSize = tta.getFloat(R.styleable.HorizontalselectedView_HorizontalselectedViewTextSize, 10);
